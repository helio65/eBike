...
var
   ...
   AListEventoParticipante : TObjectList<TEventoParticipante>;
begin
   ...
   try
      ...
      ADMCon.Conexao.StartTransaction;
      AListEventoParticipante := TObjectList<TEventoParticipante>.Create;
      ...
      try
         ...
         while not AFDQuery.Eof do begin
            ...
            AListEventoParticipante.Add(AEventoParticipante);

            AFDQuery.Next;

         end;

         Result := AListEventoParticipante;
...
begin
   ...
   try
      ...
      try
         ...
         AFDQuery.Open(AStrBuilder.ToString, [ACO_Evento_Participante]);
